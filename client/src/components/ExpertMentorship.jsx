  ...
  return (
    <section className="expert-mentorship">
      <div className="container em-top">
        <div className="em-copy" data-reveal>
          ...
          <p className="section-sub">
            Small batches mean real back-and-forth with an
            instructor — not a recorded lecture you watch alone.
          </p>

          <div className="em-grid" data-reveal-group>
            {features.map((f) => (
              <div className="em-card" data-reveal-item key={f.title}>
        ...
        <div className="em-visual" aria-hidden="true" data-reveal-group>
          <div className="left-card" id="card-qe" data-reveal-item>
          ...
          <div className="left-card" id="card-community" data-reveal-item>
          ...
          <div className="float-card" id="card-hands" data-reveal-item>
          ...
          <div className="float-card" id="card-code" data-reveal-item>
          ...
          <div className="left-card" id="card-vision" data-reveal-item>
      ...
      <div className="container">
        <div className="em-banner" data-reveal>
